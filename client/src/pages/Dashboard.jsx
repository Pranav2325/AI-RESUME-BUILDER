    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            <Plus className="size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-green-300 to-green-500 text-white rounded-full" />
            <p>Create Resume</p>
          </button>
            ...
            return (
              ...
              >
                ...
                <div onClick={e=>e.stopPropagation()} className="absolute top-1 right-1 group-hover:flex items-center hidden">
                  ...
                  <Pencil onClick={()=> {setEditResumeId(resume._id);
        ...
        {/* functionality for create resume button */}
        ...
        {/* functionality for upload resume button */}
        {showUploadResumes && (
          <form
        ...
        {/* functionality for edit resume button */}
