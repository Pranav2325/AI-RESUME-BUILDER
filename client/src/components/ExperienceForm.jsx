            ...
            >
              ...
              <label className="flex items-center gap-2">
               ...
               <div className="space-y-2">
                  ...
                  <textarea rows={4} value={experience.description||""} onChange={(e)=>updateExperience(index,"description",e.target.value)} className="w-full text-sm px-3 py-2 runded-lg resize-none" placeholder="Describe your key responsibilities and achivements..."/>
